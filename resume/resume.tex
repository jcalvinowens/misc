...
\itemsep 0em
	...
	\item https://github.com/jcalvinowens/relayclock
\end{itemize}

\noindent {\bf sdvr} \hfill {\bf 2021 -}
\begin{itemize}[leftmargin=2em]
\itemsep 0em
	\item https://github.com/jcalvinowens/sdvr
	\item Experimental video stream aggregator
	\item Uses NaCl for auth/crypto
\end{itemize}
